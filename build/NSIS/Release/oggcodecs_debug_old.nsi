...
!define VS_RUNTIME_LOCATION_DEBUG ..\..\..\bin\debug
...
!define PRODUCT_NAME "oggcodecs_debug"
...
!define OGGCODECS_CONFIG_PATH "Debug"
!define OGGCODECS_VORBIS_CONFIG_PATH "Vorbis_Dynamic_Debug"
...
Section "Oggcodecs Core Files" SEC_CORE
  ...
  File "${VS_RUNTIME_LOCATION_PREFIX}r80D.dll"
  File "${VS_RUNTIME_LOCATION_PREFIX}p80D.dll"
  File "${VS_RUNTIME_LOCATION_DEBUG}\Microsoft.VC80.CRT.manifest"
  ...
  File "${OGGCODECS_ROOT_DIR}\src\lib\codecs\vorbis\libs\libvorbis\win32\${OGGCODECS_VORBIS_CONFIG_PATH}\vorbis_d.dll"
